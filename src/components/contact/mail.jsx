    ...
    if (!username) {
      ...
      axios.post('http://localhost:5000/send', data)
        .then((response) => {
          ...
          setSubject("");
          setMessage("");
          alert(`Thank you dear ${username}, Your message has been sent successfully!`);
        })
        .catch((error) => {
            ...
            <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5" onSubmit={handleSend}>
              ...
              <div className="flex flex-col gap-4">
                ...
                <input
                  ...
                  value={email}
                  className={`contactInput ${errMsg === "Please provide your Email!" || errMsg === "Please provide a valid Email!" ? "outline-designColor" : ""}`}
                  type="email"
                />
              </div>
              <div className="flex flex-col gap-4">
                ...
                <input
                  ...
                  value={subject}
                  className={`contactInput ${errMsg === "Subject is required!" ? "outline-designColor" : ""}`}
                  type="text"
                />
              </div>
              <div className="flex flex-col gap-4">
